...
var GlobalData = function GlobalData() {
    ...
    this.login = function (theValue) {
        _this._login = theValue;
    };
...
var globalData = exports.globalData = new GlobalData();
...
var _testApi = __webpack_require__(81);
...
var Main = function Main() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { path: '/test', component: _testApi2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/notification', component: _notification2.default })
        )
    );
};
...
var _globalData = __webpack_require__(41);
...
var Login = function (_Component) {
    ...
    function Login(props) {
        ...
        _this.handleKeyPressUsername = function (event) {
            if (event.key == 'Enter') {
        ...
        _this.handleKeyPressPassword = function (event) {
            if (event.key == 'Enter') {
                event.preventDefault();
            }
        };
    ...
    _createClass(Login, [{
        ...
        value: function handleSubmitClick() {
            ...
            if (status) {
                ...
                if (username == "admin" && password == "password") {
                    _globalData.globalData.login(true);
        ...
        value: function render() {
            ...
            if (this.state.redirect) {
                return _react2.default.createElement(_reactRouter.Redirect, { push: true, to: '/home' });
            }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h3',
                    null,
                    'Welcome to Grants.gov Admin Page'
                ),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col-sm-4' },
                            _react2.default.createElement('input', { type: 'text', ref: 'userid', value: this.state.username,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col-sm-4' },
                            _react2.default.createElement('input', { type: 'password', ref: 'password', value: this.state.password,
...
var Home = function Home() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'h4',
      null,
      'The admin application contains the following sections: '
    ),
    _react2.default.createElement('br', null),
    _react2.default.createElement(
      'ul',
      ...
      _react2.default.createElement(
        ...
        ' send notice notification to mobile users'
      )
    ),
    _react2.default.createElement(
      'ul',
...
var rowStyle = { marginTop: "8px" };
var headStyle = { backgroundColor: "#efefef" };

var SendNotification = function (_Component) {
    _inherits(SendNotification, _Component);

    function SendNotification(props) {
        _classCallCheck(this, SendNotification);

        var _this = _possibleConstructorReturn(this, (SendNotification.__proto__ || Object.getPrototypeOf(SendNotification)).call(this, props));

        _this.handleKeyPress = function (event) {
            if (event.key == 'Enter') {
                _this.refs.detail.focus();
                event.preventDefault();
            }
        };

        _this.updateSubject = function (evt) {
            _this.setState({ subject: evt.target.value, subjectError: "" });
        };

        _this.updateDetail = function (evt) {
            _this.setState({ detail: evt.target.value, detailError: "" });
        };
        ...
        _this.handleSubmitClick = function () {
            ...
            if (subject == null || subject.length == 0 || subject.trim().length == 0) {
                _this.setState({ subjectError: "Subject can't be empty" });
                status = false;
            }

            var detail = _this.state.detail;
            if (detail == null || detail.length == 0 || detail.trim().length == 0) {
                _this.setState({ detailError: "Detail can't be empty" });
                status = false;
            }
    ...
    _createClass(SendNotification, [{
        ...
        value: function logout() {
            _globalData.globalData.login(false);
        }
    }, {
        key: 'render',
        value: function render() {
            if (!_globalData.globalData.isLogin()) {
                return _react2.default.createElement(Redirect, { push: true, to: '/' });
            }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'small',
                                { id: 'subject-error', className: 'text-danger' },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col-sm-8' },
                            _react2.default.createElement('textarea', { type: 'text', ref: 'detail', className: 'form-control',
                                placeholder: 'Detail for notification',
                                rows: '5',
                                onChange: this.updateDetail }),
                            _react2.default.createElement(
                                'small',
                                { id: 'detail-error', className: 'text-danger' },
